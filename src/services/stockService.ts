...
const INDIA_STOCKS_FOR_FALLBACK = new Set([
  ...
  'ONGC', 'COALINDIA', 'BPCL', 'IOC', 'GRASIM', 'TECHM', 'DIVISLAB',
  'DRREDDY', 'CIPLA', 'EICHERMOT', 'M&M', 'HEROMOTOCO', 'BAJAJ-AUTO',
  'BRITANNIA', 'NESTLEIND', 'DABUR', 'PIDILITIND', 'GODREJCP', 'MARICO',
  'COLPAL', 'HAVELLS', 'VOLTAS', 'CROMPTON', 'BLUESTAR', 'TATAPOWER',
  'ADANIGREEN', 'JSWSTEEL', 'HINDALCO', 'VEDL', 'GAIL', 'INDUSINDBK',
  'BANDHANBNK', 'PNB', 'BANKBARODA', 'CANBK', 'SBILIFE', 'HDFCLIFE', 'ICICIPRULI',
]);
