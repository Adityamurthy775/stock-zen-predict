...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a helpful stock market AI assistant. You provide clear, concise information about:
...
- Indian (NSE/BSE) and US (NYSE/NASDAQ) stock markets
- Commodities like Gold and Silver ETFs
...
- If asked about specific stocks, explain what factors to consider
